...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Hi, I'm Dorian
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a Software Engineer with experience in React, JavaScript,
            HTML, CSS, Bootstrap, Python, Django. I am also a Graphic Designer with experience in Adobe Photoshop, 
            Corel Draw, Figma, UX/UI and also other technologies and frameworks. 
            I am a hard worker and I am always looking to learn new things.</p>
